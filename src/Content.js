    ...
    const getContent = selectedMenuItem => {
        switch (selectedMenuItem) {
            ...
            case 2:
                ...
                rel="noopener noreferrer">this link</a> to send me $15 USD and the email address you use to sign into Google Chrome and you will get premium for all of FIFA 20.</p><p>If you have any questions or concerns, please send me an email (shortfuts@gmail.com) or DM me on <a href="https://www.twitter.com/shortfuts" target="_blank"
